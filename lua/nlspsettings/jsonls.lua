...
local schemas = {
  -- als                    = '',
  -- angularls              = '',
  bashls                 = 'https://raw.githubusercontent.com/tamago324/nlsp-settings.nvim/main/schemas/bashls.json',
  -- beancount              = '',
  -- ccls                   = '',
  -- clangd                 = '',
  -- clojure_lsp            = '',
  ...
  -- codeqlls               = '',
  -- configs                = '',
  cssls                  = 'https://raw.githubusercontent.com/tamago324/nlsp-settings.nvim/main/schemas/cssls.json',
  -- dartls                 = '',
  -- denols                 = '',
  -- dhall_lsp_server       = '',
  -- diagnosticls           = '',
  ...
  -- gdscript               = '',
  -- ghcide                 = '',
  gopls                  = 'https://raw.githubusercontent.com/tamago324/nlsp-settings.nvim/main/schemas/gopls.json',
  -- graphql                = '',
  -- groovyls               = '',
